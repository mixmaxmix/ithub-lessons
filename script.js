...
let activeTab = 'lessons'; // Отвечает, за активную вкладку на экране
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.querySelector('#nav_n').addEventListener('click', async () => {
        ...
        notificationsCont.innerHTML = '<h2 class="main__title">Уведомления</h2>';
        ...
        notificationsArray.forEach(n => {
            ...
            if (n.type === 'change') {
                ...
                <div class="notifications__content">
                    <p class="notitfication__title notitfication_type-${n.importance}">Замена ${n.title}:</p>
                ...
                notification.innerHTML = `
                <div class="notifications__content">
                    <p class="notitfication__title notitfication_type-${n.importance}"><span class="notitfication__title_sender">${n.body.sender} сообщает:<span/> ${n.title}</p>
                        <div class="notifications_info">
